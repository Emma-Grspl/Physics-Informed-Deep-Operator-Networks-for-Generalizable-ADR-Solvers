...
- [docs/experimental_protocol.md](docs/experimental_protocol.md): full experimental roadmap from baseline validation to framework benchmarking
- [docs/reproducibility.md](docs/reproducibility.md): exact compute environment, seeds, hardware, hyperparameters, and training settings
