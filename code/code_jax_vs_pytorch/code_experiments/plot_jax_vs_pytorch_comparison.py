...
def load_models_and_cfg():
    cfg_pt = load_yaml(CODE_ROOT / "configs" / "config_ADR_t1_compare.yaml")
    cfg_jax = load_yaml(CODE_ROOT / "configs_jax" / "config_ADR_jax_t1_equal_pipeline.yaml")
...
def plot_snapshots() -> None:
    ...
    fig, axes = plt.subplots(len(cases), 1, figsize=(12.5, 13.4), sharex=True)
    model_styles = {
