"""PyTorch benchmark entry point `benchmarks.pytorch.eval_benchmark`.

This script configures the PyTorch benchmark workflow and runs the eval benchmark stage for a selected ADR protocol.
"""
