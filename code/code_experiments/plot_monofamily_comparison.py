...
ASSET_DIR = REPO_ROOT / "assets" / "monofamily"
BENCH_ROOTS = [
...
FAMILY_META = {
    "Tanh": {
        ...
        "pt_cfg": CODE_ROOT / "configs" / "config_ADR_t1_tanh_only.yaml",
        "jax_cfg": CODE_ROOT / "configs_jax" / "config_ADR_jax_t1_tanh_only.yaml",
    },
    "Sin-Gauss": {
        "bench_name": "singauss_only",
        "type_id": 1,
        "physics": {"type": 1, "v": 0.8, "D": 0.1, "mu": 0.5, "A": 1.0, "sigma": 0.5, "k": 2.0},
        "pt_cfg": CODE_ROOT / "configs" / "config_ADR_t1_singauss_only.yaml",
        "jax_cfg": CODE_ROOT / "configs_jax" / "config_ADR_jax_t1_singauss_only.yaml",
    },
    "Gaussian": {
        "bench_name": "gaussian_only",
        "type_id": 3,
        "physics": {"type": 3, "v": 0.8, "D": 0.1, "mu": 0.5, "A": 1.0, "sigma": 0.5, "k": 2.0},
        "pt_cfg": CODE_ROOT / "configs" / "config_ADR_t1_gaussian_only.yaml",
        "jax_cfg": CODE_ROOT / "configs_jax" / "config_ADR_jax_t1_gaussian_only.yaml",
    },
}
...
def plot_snapshots(bundle: dict) -> None:
    ...
    fig.subplots_adjust(top=0.90, right=0.80, hspace=0.24)
    fig.legend(
