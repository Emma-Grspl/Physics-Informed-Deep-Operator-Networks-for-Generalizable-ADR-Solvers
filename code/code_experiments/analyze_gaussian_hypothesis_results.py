...
RESULTS_DIR = REPO_ROOT / "outputs" / "benchmarks"
OUT_DIR = REPO_ROOT / "figures" / "gaussian_hypothesis"
    ...
    rows.append(
        {
            ...
            "source": str(free_dir.parent.relative_to(REPO_ROOT)),
        }
    )
    ...
    rows.append(
        {
            ...
            "source": str(ansatz_dir.parent.relative_to(REPO_ROOT)),
        }
    )
