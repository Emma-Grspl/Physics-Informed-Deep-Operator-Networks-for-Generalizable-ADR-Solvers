...
#Utils and configs
DEFAULT_CONFIG_PATH = Path(project_root) / "configs" / "config_ADR.yaml"
    ...
    for i in pbar:
        ...
        if i % 1000 == 0:
            if i > 0:
                ...
                current_failed_ids = diagnose_model(model, device, cfg, threshold=target_threshold, t_max=t_max) # 
...
"""
    ...
    load_dir = "/lustre/fswork/projects/rech/fdb/usv13rn/These_DeepONet_ADR/results/run_20260227-153846/"
